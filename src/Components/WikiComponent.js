  ...
  return (
    <div className="wiki-container">
      ...
      <ul className="WikiLinks">
        ...
        <li onClick={() => handleInfoClick('Die <strong>Standardabweichung (sd)</strong> ist ein Maß für die Streuung um den Mittelwert. Er gibt also Auskunft darüber, wie die Werte im Durchschnitt vom Mittwelwert abweichen.')} className="clickable-item">Infos über Standardabweichung</li>
